    ...
    namespace ExpenseManager.App.Views.Admin.Sidebar
    {
        ...
        private void InitializeComponent()
        {
            ...
            lblAdminRole.Size = new Size(157, 20);
            lblAdminRole.TabIndex = 2;
            lblAdminRole.Text = "Hệ thống quản trị viên";
            // 
            // lblAdminName
            // 
            ...
            btnSupport.Text = "Hỗ trợ/ Yêu cầu";
            ...
            lblTitle.TabIndex = 0;
            lblTitle.Text = "Quản lý chi tiêu";
            ...
            Text = "Quản lý chi tiêu - Quản trị viên";
